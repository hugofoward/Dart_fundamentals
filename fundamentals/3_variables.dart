// In this example, we will create variables with another way
/// Neste exemplo iremos criar as variáveis de outra forma
main() {
  /*
  In this example instead of explicitly defining a variable a type like int,
  we will use var, the value assigned to this variable will define its type, in the example below
  the variable 'n1', will be of type int because the assigned value is an integer.
  */ /*
  Neste exemplo ao invés de definirmos uma variável de forma explícita um tipo como int,
  utilizaremos o var, o valor atribuído a esta variável definirá o seu tipo, no exemplo abaixo
  ...
  */
  ...
  //You can check if is true or false the type of specific variable
  ///Você pode verificar se é verdadeiro ou falso o tipo de variável específica
