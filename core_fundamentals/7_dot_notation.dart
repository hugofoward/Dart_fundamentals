...
*/
  ...
  print(s2);
/*
  O toUpperCase, allows the string to be uppercase.
  O toUpperCase permite que a string seja maiúscula.
*/
  print("Exemplo var s3");
  String s3 = s2.toUpperCase();
  print(s3);
/* 
  O padRight is used to complete the string with the desired number of characters,
  below it is defined that the string will have 15 characters and will be completed to the right with !!!

  O padRight é utilizado para completar a string com o número de caracteres desejados,
