...
/* 
  ...
  O stdin.readLineSync permite que o usuário insira um valor
...
/* 
  You can create a constant from a constant, but in Dart it is not possible to create a constant from final type.
  Você pode criar uma constante a partir de uma constante, mas no Dart não é possivel criar uma constante a partir do tipo final
*/
